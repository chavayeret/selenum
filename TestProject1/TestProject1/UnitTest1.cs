...
namespace TestProject1
{
    ...
    public class GoogleSearchTest
    {
        ...
        public static IEnumerable<TestData> TestCases => XmlDataReader.ReadTestData("T:\\����� �����\\��� �\\����� �\\���� ��������\\�����4\\SeleniumProject\\SeleniumProject\\TestData.xml");


        [OneTimeSetUp]
        public void SetUp()
        {
            string path = "T:\\����� �����\\��� �\\����� �\\���� ��������\\�����4\\SeleniumProject\\SeleniumProject";
